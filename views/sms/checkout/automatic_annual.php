...
error_log("Automatic Annual loaded");
...
$razorpayOrder3 = $api->order->create($orderData3);

$razorpayOrderId3 = $razorpayOrder3['id'];

$_SESSION['razorpay_order_id3'] = $razorpayOrderId3;
...
$data = [
        ...
        "image"             => "https://simonline.in/img/ico192.png",
        "prefill"           => [
                "name"              => $user_name,
                "email"             => $user_email,
                "contact"           => $user_phone,
        ...
        "order_id"          => $razorpayOrderId3,
];

$json = json_encode($data);
$gsm_order->updateVenderOrderId($user_id, $order_id, $razorpayOrderId3);
?>
