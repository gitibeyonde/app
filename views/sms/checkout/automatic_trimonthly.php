...
error_log("Automatic TriMonthly loaded");

$amount=100;

$gsm_order = new GsmOrder();
$order_id = $gsm_order->addOrder($user_id, 'trmt', $phone, $amount, 'init');
...
$razorpayOrder2 = $api->order->create($orderData2);

$razorpayOrderId2 = $razorpayOrder2['id'];

$_SESSION['razorpay_order_id2'] = $razorpayOrderId2;
...
$data = [
        ...
        "order_id"          => $razorpayOrderId2,
];

$json = json_encode($data);
$gsm_order->updateVenderOrderId($user_id, $order_id, $razorpayOrderId2);
?>
