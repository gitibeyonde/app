...
class Utils {
    ...
    public $action = array ('left' => array (0 => 'Restart',1 => 'Remove',2 => 'Snap',3 => 'Settings',4 => 'EnbHrSnap',5 => 'IncFaceMin',
            6 => 'EnFcDtct',7 => 'IncTol',8 => 'IncMDelta',9 => 'EnGrd',10 => 'Hflip', 11=>'DecBrt', 12=>'DecMotionQ', 13=>'DecSnapQ', 14=>'RecordToggle'
    ),
            'right' => array (0 => 'Reset',1 => 'Update',2 => 'Buzz',3 => 'Rote', 4 => 'DsbHrSnap',5 => 'DecFaceMin',
                    6 => 'DsFcDtct',7 => 'DecTol',8 => 'DecMDelta',9 => 'DsGrd',10 => 'Vflip', 11=>'InrBrt', 12=>'IncMotionQ', 13=>'IncSnapQ', 14=>'SmsPing'
            )
    );
    public $action_message = array ('Restart' => 'Restart','Update' => 'Update','Reset' => 'Reset','Snap' => 'Snap','Buzz' => 'Buzz','Rote' => 'Rotate 90deg Clockwise','Settings' => 'Get Setting','Remove' => 'Remove',
            'EnbHrSnap' => 'Enable Hourly Snapshot','DsbHrSnap' => 'Disable Hourly Snapshot','IncFaceMin' => 'Increase minimum face size detected','DecFaceMin' => 'Decrease minimum face size detected','EnFcDtct' => 'Enable Face Detection',
            'DsFcDtct' => 'Disable Face Detection','IncTol' => 'Decrease Motion Sensitivity','DecTol' => 'Increase Motion Sensitivity','IncMDelta' => 'Increase Motion Capture Interval',
            'DecMDelta' => 'Decrease Motion Capture Interval', 'EnGrd' => 'Enable Grid Sensitivity', 'DsGrd' => 'Disable Grid Sensitivity' ,
            'Vflip' => 'Camera Vertical Flip', 'Hflip' => 'Camera Horizontal Flip', 'DecBrt' => 'Decrease Camera Brightness','InrBrt' => 'Increase Camera Brightness',
            'DecMotionQ' => 'Decrease Motion Capture Quality','IncMotionQ' => 'Increase Motion Capture Quality',
            'DecSnapQ' => 'Decrease Snap Capture Quality','IncSnapQ' => 'Increase Snap Capture Quality',
            'RecordToggle'=>'Start/Stop Recording from current location', 'SmsPing'=>'SmsPing The device pings back'
    );
    ...
    public $mp4web = array('Mp4Web', 'Mp4 Chunk Size optimized for web', '', 'This will change the Mp4 chunk size and will take some time to take effect.');
    public $mp4device = array('Mp4Device', 'Mp4 Chunk Size for peer to peer', '', 'This will change the Mp4 chunk size and will take some time to take effect.');
    public $mjpegmode = array('MjpgMode', 'Chnage to Mjpeg Mode', '', 'This will change camera mode to Mjpeg and will take some time to take effect.');
    public $mp4mode = array('Mp4Mode', 'Chnage to Mp4 Mode', '', 'This will change camera mode to Mp4 and will take some time to take effect.');
    ...
    //GPRS
    public $smsping = array('SmsPing', 'The device pings its number using SMS', '', '');
